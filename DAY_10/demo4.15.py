...
with open('E:\python_learn/data/python.csv', 'rt') as file1, \
        open('E:\python_learn/data/python_test.csv', 'rt') as file2, \
        open('E:\python_learn/data/merged_file.csv', 'wt', encoding='utf-8') as outf:
